...
public:
    ...
    void setupUi(QDialog *Overlay)
    {
        ...
        Home_Pen_Back->setGeometry(QRect(8, 70, 292, 50));
        QFont font1;
        ...
        Away_Graphic->setGeometry(QRect(473, 3, 289, 70));
        ...
        Away_Score->setGeometry(QRect(393, 8, 75, 50));
        ...
        Away_Pen_Back->setGeometry(QRect(465, 70, 292, 50));
        ...
        EvenBack->setGeometry(QRect(937, 70, 310, 50));
        ...
        EvenText->setGeometry(QRect(975, 71, 119, 42));
        QFont font3;
        ...
        HPPClock->setGeometry(QRect(174, 71, 120, 42));
        ...
        HPPText->setGeometry(QRect(46, 71, 119, 42));
        ...
        Background->setGeometry(QRect(0, 0, 1255, 75));
        ...
        Home_Graphic->setGeometry(QRect(2, 3, 289, 70));
        ...
        EvenClock->setGeometry(QRect(1096, 71, 120, 42));
        ...
        Period->setGeometry(QRect(958, 8, 75, 50));
        Period->setFont(font);
        ...
        APPClock->setGeometry(QRect(280, 71, 120, 42));
        ...
        APPText->setGeometry(QRect(480, 71, 119, 42));
        ...
        APPClock->raise();
        APPText->raise();
        Clock = new QLabel(Overlay);
        Clock->setObjectName(QString::fromUtf8("Clock"));
        Clock->setEnabled(true);
        Clock->setGeometry(QRect(920, 400, 141, 50));
    ...
    void retranslateUi(QDialog *Overlay)
    {
        ...
        Home_Score->setText(QApplication::translate("Overlay", "0", nullptr));
        Home_Pen_Back->setText(QString());
        Home_Color->setText(QString());
        Away_Graphic->setText(QString());
        Home_Name->setText(QApplication::translate("Overlay", "Home", nullptr));
        Away_Score->setText(QApplication::translate("Overlay", "0", nullptr));
        Away_Pen_Back->setText(QString());
        EvenBack->setText(QString());
        Away_Name->setText(QApplication::translate("Overlay", "Away", nullptr));
        ...
        Period->setText(QApplication::translate("Overlay", "1st", nullptr));
        APPClock->setText(QString());
        APPText->setText(QString());
        Clock->setText(QApplication::translate("Overlay", "00:00", nullptr));
    } // retranslateUi
